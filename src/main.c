...
int main() {
    ...
    //imprimir cuántas casas se cargaron simplemente accediendo dentro del struct a counter y mostrarlo al usuario
    printf("%d houses loaded\n", houses_list.counter);
    
    //imprimir cuántos places se cargaron simplemente accediendo dentro del struct a counter y mostrarlo al usuario
